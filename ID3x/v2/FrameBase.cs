...
namespace MixFlow.ID3v2
{
	public class Frame
	{
		...
		//Methods
		public Frame(string name, object value, string version = FrameLatestVersion)
		{
			FrameName = name;
			FrameValue = value;
		}
	...
	{
		private static readonly string[] array = new string[]
			{
		...
		public static readonly List<string> list = new List<string>(array);
	}
}
