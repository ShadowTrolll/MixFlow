...
namespace MixFlow_BareboneCSCore
{
	...
	class Program
	{
		static int Main(string[] args)
		{
			...
			//Init
			ConfigJson configTest = new ConfigJson(testFilePath);

			configTest.SetStr(ref testFilePath);
			configTest.SetStr(nameof(Config.ConfigPathMain), Config.ConfigPathMain);
			...
			Console.WriteLine(configTest.GetStr(nameof(Config.ConfigPathDB)));
			Console.WriteLine(configTest.GetStr("testVar"));
